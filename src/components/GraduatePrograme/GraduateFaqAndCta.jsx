  ...
  return (
    <section className="w-full bg-white py-12 sm:py-20 lg:py-28 px-4 sm:px-6 lg:px-12 font-sans antialiased max-w-7xl mx-auto">
      <div className="w-full flex flex-col items-center space-y-16 sm:space-y-24">
        ...
        {/* FAQ Section: Standard reading width maintained for usability */}
        <motion.div 
          initial="hidden"
          whileInView="visible"
            ...
            {faqs.map((faq, idx) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <span className={`text-xs sm:text-sm md:text-base font-bold tracking-tight transition-colors duration-200 flex-1 ${
        ...
        {/* CTA Banner Section: Max-width increased to max-w-6xl for full prominent look */}
        <motion.div
            ...
            <div className="space-y-4 sm:space-y-6 w-full max-w-2xl flex flex-col items-center lg:items-start">
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-x-4 gap-y-2.5 pt-3 border-t border-neutral-800/60 w-full">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[11px] sm:text-xs font-bold text-white">500+ Placed</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <Zap className="w-3.5 h-3.5 text-[#50d523] shrink-0" />
                  <span className="text-[11px] sm:text-xs font-bold text-white">12 Weeks Track</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <MessageCircle className="w-3.5 h-3.5 text-[#50d523] shrink-0" />
                  <span className="text-[11px] sm:text-xs font-bold text-white">24/7 Support</span>
                </div>
              </div>
