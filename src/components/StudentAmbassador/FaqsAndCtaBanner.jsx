      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center space-y-5">
          <motion.div variants={itemVariants} className="inline-flex items-center gap-2 bg-green-50 border border-green-100 rounded-full px-4 py-1.5">
            ...
            <span className="text-xs font-bold text-[#43A047] uppercase tracking-wider">FAQ</span>
          </motion.div>
          ...
          <motion.p variants={itemVariants} className="text-gray-500 text-sm lg:text-base">
            Everything you need to know about being an ambassador
          </motion.p>
        </motion.div>
            ...
            return (
              <motion.div 
                ...
                className={`border rounded-2xl transition-all duration-300 overflow-hidden bg-white ${
                  isOpen ? 'border-[#43A047]/30 shadow-lg shadow-green-500/10' : 'border-gray-100 hover:border-gray-200'
                }`}
              >
                {/* Trigger Button */}
                <motion.button
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className={`w-8 h-8 rounded-xl flex items-center justify-center transition-colors ${
                      isOpen ? 'bg-[#43A047] text-white' : 'bg-gray-100 text-gray-500'
                    }`}>
                  ...
                  {isOpen && (
                    ...
                    >
                      <div className="px-6 py-5 pt-0 border-t border-gray-100">
                        <p className="text-gray-500 text-sm leading-relaxed pl-0 md:pl-12">
                          {faq.answer}
                        </p>
                      </div>
                    </motion.div>
      ...
      >
        ...
        >
          ...
          >
            ...
            <span className="text-xs font-medium text-gray-300">Join 300+ Student Ambassadors</span>
          </motion.div>
