...
export default function StudentAmbassadorsHero() {
  // 1. Bottom Feature Highlight Matrix Dataset (with Font Awesome Icons)
  const features = [
  ...
  // 2. Core Value Perks Dataset (Why You Should Join - with Font Awesome Icons)
  const whyJoin = [
    {
    ...
    <div className="w-full bg-white font-sans antialiased px-6 py-20 lg:py-28 md:px-12 lg:px-16 max-w-7xl mx-auto selection:bg-green-100">
      ...
      >
        ...
        <motion.div
          ...
          className="space-y-7 max-w-xl text-left"
        >
        ...
        <motion.div
          variants={itemVariants}
          className="space-y-6 lg:pl-6 w-full"
        >
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 bg-[#E8F5E9] text-[#43A047] rounded-xl flex items-center justify-center shrink-0">
                  <FontAwesomeIcon icon={faUsers} className="text-sm" />
                </div>
                <div>
            ...
            <div className="grid grid-cols-3 gap-3 text-center">
              <div className="border border-dashed border-gray-200 rounded-xl p-3 bg-gray-50/50">
                <p className="text-lg sm:text-xl font-black text-gray-950">
                  34
                </p>
      ...
      >
        {features.map((feature, index) => {
          return (
            ...
            >
              <div className="w-9 h-9 bg-[#E8F5E9] text-[#43A047] rounded-xl flex items-center justify-center shrink-0 group-hover:scale-105 group-hover:bg-[#43A047] group-hover:text-white transition-all">
      ...
      >
        <motion.div variants={itemVariants} className="space-y-3 text-left">
          ...
          <p className="text-gray-500 text-xs sm:text-sm md:text-base font-medium">
            Build enterprise-ready tech skills, grow your global network, and
            create real campus impact.
          </p>
        </motion.div>
          ...
          {whyJoin.map((item, index) => {
            return (
              ...
              >
                ...
                <div className="flex items-center gap-2 text-[#43A047] opacity-0 group-hover:opacity-100 transition-all duration-300 pt-4">
