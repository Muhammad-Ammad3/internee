    ...
    <div className="w-full bg-white font-sans antialiased px-6 py-20 lg:py-28 md:px-12 lg:px-16 max-w-7xl mx-auto">
      ...
      >
        <motion.div variants={itemVariants} className="inline-flex items-center gap-2 bg-green-50 border border-green-100 rounded-full px-4 py-1.5">
          ...
          <span className="text-xs font-bold text-[#43A047] uppercase tracking-wider">Recognition & Awards</span>
        </motion.div>
        ...
        {achievements.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              {/* Image Container Wrapper */}
              <motion.div variants={imageVariants} className={`col-span-1 lg:col-span-6 relative ${isImageRight ? 'lg:order-last' : ''}`}>
                <motion.div 
                  ...
                  className={`w-full overflow-hidden rounded-3xl border border-gray-100 shadow-xl shadow-gray-100/50 relative transition-all duration-500 group-hover:shadow-2xl ${
                    item.isYellowBanner ? 'bg-gradient-to-br from-yellow-400 to-amber-500' : 'bg-slate-50'
                  }`}
                >
              ...
              {/* Text Meta Content Block */}
              <motion.div variants={itemVariants} className="col-span-1 lg:col-span-6 space-y-5 lg:px-6">
                
                {/* Meta Indicator (Star + Label) */}
                <div className="flex items-center gap-2 text-[#43A047] text-xs font-bold tracking-wider uppercase">
                  <Star className="w-4 h-4 fill-[#43A047]" />
                  <span>2024 Recognition</span>
                </div>
