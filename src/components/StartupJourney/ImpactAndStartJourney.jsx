...
export default function ImpactAndStartJourney() {
  // 1. Checkmarks With Contextual Icons Dataset (Font Awesome ke sath)
  const checkmarks = [
    {
          ...
          <div className="space-y-3.5 pt-2">
            {checkmarks.map((item, index) => {
              return (
                ...
                >
                  <div className="w-6 h-6 rounded-full bg-[#E8F5E9] border border-[#43A047]/10 flex items-center justify-center shrink-0 mt-0.5 group-hover:bg-[#43A047] transition-colors duration-200">
                    <FontAwesomeIcon
                      icon={item.icon}
                      className="text-[10px] text-[#43A047] group-hover:text-white transition-colors"
                    />
                  </div>
          ...
          <div className="inline-flex items-center gap-2 bg-[#2E2E2E] border border-neutral-800 rounded-full py-1.5 pl-2 pr-4 select-none">
            <div className="w-5 h-5 bg-[#43A047]/20 border border-[#43A047]/30 rounded-full flex items-center justify-center">
              <FontAwesomeIcon
                ...
                className="text-[10px] text-[#43A047]"
              />
            </div>
