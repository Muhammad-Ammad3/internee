      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full space-y-28 md:space-y-36">
        ...
        >
          ...
          <div className="lg:col-span-6 space-y-6 text-left lg:pl-12 order-1 lg:order-2">
            <motion.div
              variants={itemVariants}
              className="inline-block bg-green-50 text-[#40b71c] text-[10px] font-black uppercase tracking-wider px-3 py-1 rounded-full border border-green-100"
            >
              Why Internee.pk?
            </motion.div>
            ...
            <motion.p
              variants={itemVariants}
              className="text-gray-500 font-medium text-sm sm:text-base leading-relaxed max-w-xl"
            >
              We don't just provide tasks; we provide a career launchpad. Join
              the movement that's redefining the virtual internship experience
              in Pakistan.
            </motion.p>
            ...
            <motion.div variants={itemVariants} className="space-y-5 pt-4">
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 font-medium leading-normal mt-0.5">
                    Gain access to trusted opportunities from reputable
              ...
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  <h5 className="text-sm font-black text-slate-900 tracking-tight">
                    LMS for Skill Growth
                  </h5>
                  <p className="text-xs text-gray-400 font-medium leading-normal mt-0.5">
                    Access our Learning Management System to upskill with
              ...
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 font-medium leading-normal mt-0.5">
                    Explore full-time job opportunities after your internship
              ...
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 font-medium leading-normal mt-0.5">
                    Learn on your own schedule with our remote-first approach
        ...
        <div className="space-y-12">
          <div className="text-center space-y-2.5 max-w-2xl mx-auto">
            ...
            <p className="text-gray-400 font-medium text-xs sm:text-sm max-w-lg mx-auto leading-relaxed">
              Transforming Pakistan's tech talent landscape through education
              and opportunity
            </p>
          </div>
          ...
          >
            {impactStats.map((stat) => (
              ...
              >
                <div
                  className={`w-11 h-11 rounded-xl ${stat.themeColor} flex items-center justify-center shadow-xs`}
                >
