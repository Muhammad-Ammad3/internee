...
const TaskPlatform = () => {
  ...
  return (
    <section className="w-full bg-[#0a0a0a] text-white py-20 lg:py-28 px-6 lg:px-12 font-sans relative overflow-hidden">
      ...
      {/* Decorative Subtle Background Shapes */}
      <div className="absolute right-0 top-10 w-96 h-96 bg-[#43A047]/10 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <motion.p variants={itemVariants} className="text-gray-400 text-sm lg:text-base max-w-2xl mx-auto font-medium leading-relaxed">
            Complete real tasks, get structured feedback, and build a portfolio employers trust. Every milestone moves you closer to job-ready.
          </motion.p>
        </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-400 text-sm leading-relaxed font-normal">
                  Experience the complete Software Development Life Cycle through structured tasks and milestones.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-400 text-sm leading-relaxed font-normal">
                  Follow a structured learning path designed for both beginners and advanced learners.
                </p>
              </div>
            </motion.div>
          ...
          <motion.div
            ...
            className="w-full bg-gradient-to-r from-[#111111] to-[#151c2c] border border-gray-800/80 rounded-3xl p-8 sm:p-12 lg:p-16 text-center relative overflow-hidden mt-10 shadow-2xl"
          >
            {/* Abstract Background Design for Bottom Banner */}
            <div className="absolute right-4 bottom-0 opacity-10 pointer-events-none hidden lg:block">
              <div className="grid grid-cols-3 gap-3">
            ...
            <div className="relative z-10 space-y-6 max-w-2xl mx-auto">
              ...
              <p className="text-gray-400 text-sm lg:text-base font-medium leading-relaxed">
                Join our virtual internships and get access to industry-standard tasks that will help you build a remarkable portfolio.
              </p>
              <motion.div 
